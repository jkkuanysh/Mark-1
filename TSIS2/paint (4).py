...
while running:
    ...
    if drawing and current_tool in shape_tools and start_pos and preview_pos:
        ...
        color_to_use = (255, 255, 255) if current_tool == "eraser" else current_color
        draw_preview_shape(preview_surface, current_tool, start_pos, preview_pos, color_to_use, brush_size)
        ...
        if event.type == pygame.QUIT:
            ...
            if drawing:
                ...
                if current_tool in shape_tools and start_pos:
                    draw_preview_shape(canvas, current_tool, start_pos, canvas_pos, current_color, brush_size)
