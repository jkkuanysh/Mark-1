...
def draw_preview_shape(surface, tool, start_pos, end_pos, color, width):
    """
    Draw a preview of the currently selected shape onto a temporary surface.
    """
...
def draw_toolbar(screen, font, current_tool, current_color, brush_size, buttons):
    """
    Draw the toolbar with tool buttons, brush sizes, and color preview.
    """
...
def get_color_palette():
    """
    Return simple built-in color swatches.
    """
    return [
